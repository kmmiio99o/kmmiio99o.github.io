        ...
        <Grid item xs={12} md={6} lg={6}>
          <Box sx={{ mb: 3 }}>
            ...
            >
              <Stack spacing={1}>
                ...
                <Typography>
                  <strong>Interests:</strong> Web Dev, Anime, Music
                </Typography>
                <Typography>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            >
              <Stack spacing={1}>
                <Typography>
                  <strong>School:</strong> Technical School - Logistics Profile
                </Typography>
                <Typography>
                ...
                <Typography>
                  <strong>IT Skills:</strong> Self-taught programming alongside
                  learning
                </Typography>
              </Stack>
            </Paper>
